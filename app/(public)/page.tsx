...
const supportCards = [
  {
    ...
    text: "Klar aufgebaut und direkt startbar.",
    icon: BookOpen,
    tone: "mint",
  },
  {
    title: "Berufssprache im Kontext",
    text: "Praxisnah für Alltag, Kurs und Arbeit.",
    icon: Briefcase,
    tone: "gold",
  },
  {
    title: "Sicher kommunizieren",
    text: "Redemittel und Training mit Struktur.",
    icon: MessageCircle,
    tone: "mint",
  },
];
    ...
    <div className="relative overflow-hidden px-4 pb-16 pt-8 md:px-6 md:pb-24 md:pt-10">
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mt-8 max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#eadfce] bg-white/82 px-4 py-2 text-sm text-slate-600 shadow-[0_18px_40px_-34px_rgba(57,73,84,0.42)]">
            <Sparkles className="h-4 w-4 text-[#73beb2]" />
            Lern-App für Berufssprache B2
          </div>
          <h1 className="mt-6 text-[2.65rem] leading-[0.95] text-slate-900 md:text-[4rem] [font-family:Georgia,serif]">
            Deutsch lernen.
            <br />
            Im Beruf sicher
            <br />
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-slate-600 md:text-lg">
            ...
            in einer ruhigen Oberfläche, die sich direkt wie eine moderne App anfühlt.
          </p>
        </div>

        <div className="mt-10 flex justify-center">
          <PhoneFrame className="max-w-[370px]">
            ...
            <div className="mt-6">
              ...
              <p className="mt-5 max-w-[15rem] text-sm leading-7 text-slate-600">
                Gezielter Wortschatz, sichere Kommunikation und ein Lernweg, der
                sich leicht anfühlt.
              </p>
            </div>
            ...
            <div className="mt-6 grid gap-3">
              {supportCards.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="rounded-[1.25rem] border border-[#f0e5d8] bg-white p-4 shadow-sm"
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-full ${
                          item.tone === "gold"
                            ? "bg-[#fff3e8] text-[#d39b54]"
        ...
        <div className="mx-auto mt-10 grid max-w-4xl gap-4 md:grid-cols-3">
          <QuickLink
            href="/berufsfelder"
            title="Berufsfelder"
            text="Pflege, Büro, Technik, Gastronomie und mehr."
          />
          <QuickLink
            href="/trainer"
            title="Trainer"
            text="Persönliche Unterstützung und Motivation."
          />
          <QuickLink
            href="/login"
            title="Login"
            text="Schnell anmelden und direkt weitermachen."
          />
        </div>
      </section>
    </div>
...
function QuickLink({
  ...
  return (
    <Link
      href={href}
      className="rounded-[1.5rem] border border-[#eadfce] bg-white/82 p-5 text-center shadow-[0_24px_48px_-36px_rgba(57,73,84,0.42)] transition-transform hover:-translate-y-0.5"
    >
      <p className="text-xl text-slate-900 [font-family:Georgia,serif]">{title}</p>
