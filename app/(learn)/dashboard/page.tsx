    ...
    <PhoneFrame className="max-w-[340px]">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-2 max-w-[180px] text-sm leading-6 text-slate-500">Weiter so! Du bist auf einem guten Weg.</p>
        </div>
      ...
      <div className="mt-5 rounded-[1.45rem] border border-[#f0e5d8] bg-white p-4 shadow-sm">
        ...
        <div className="mt-4 flex items-center gap-4">
          <ProgressRing value={percent || 72} size={92} strokeWidth={8} trackClassName="text-[#e7ece7]" indicatorClassName="text-[#73beb2]" label={<span className="text-[2rem] font-semibold text-slate-900">{percent || 72}</span>} />
      ...
      <div className="mt-4 space-y-3">
        {featuredDecks.map((deck, index) => (
          <div key={deck.id} className="rounded-[1.35rem] border border-[#f0e5d8] bg-white p-4 shadow-sm">
            ...
            <p className="mt-2 text-sm font-medium text-slate-900">{deck.title}</p>
      ...
      <div className="mt-4 rounded-[1.35rem] border border-[#f0e5d8] bg-white p-4 shadow-sm">
